...
public static class TestData
{
    ...
    public static Screenshot Capture(Guid? sessionId = null) => new()
    {
        ...
        Width = 1920,
        Height = 1080,
        PerceptualHash = "fixture-phash",
        Image = Image(),
        Context = new ScreenshotContext { WindowTitle = "Diapositivas", ApplicationName = "Fixture" }
    };

    public static ScreenshotImage Image() => new()
    {
        Id = Guid.Parse("33333333-3333-3333-3333-333333333333"),
        RelativePath = "sessions/fixture/captures/slide.png",
        MediaType = "image/png",
        ByteLength = 68,
